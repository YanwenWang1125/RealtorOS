...
Revision ID: 20250101_000001_initial
Revises: 
...
revision = '20250101_000001_initial'
down_revision = None
branch_labels = None
depends_on = None
...
def upgrade() -> None:
    ...
    op.create_index('ix_clients_stage_is_deleted', 'clients', ['stage', 'is_deleted'])
    op.create_index('ix_clients_email_is_deleted', 'clients', ['email', 'is_deleted'])
    op.create_index(op.f('ix_clients_id'), 'clients', ['id'])
    op.create_index(op.f('ix_clients_email'), 'clients', ['email'], unique=True)
    op.create_index(op.f('ix_clients_stage'), 'clients', ['stage'])
    op.create_index(op.f('ix_clients_is_deleted'), 'clients', ['is_deleted'])

    op.create_table(
        'tasks',
        sa.Column('id', sa.Integer(), primary_key=True, nullable=False),
        sa.Column('client_id', sa.Integer(), sa.ForeignKey('clients.id'), nullable=False),
        sa.Column('email_sent_id', sa.Integer(), sa.ForeignKey('email_logs.id'), nullable=True),
    ...
    op.create_index('ix_tasks_scheduled_status', 'tasks', ['scheduled_for', 'status'])
    ...
    op.create_index('ix_email_logs_status_client', 'email_logs', ['status', 'client_id'])
    op.create_index(op.f('ix_email_logs_id'), 'email_logs', ['id'])
    op.create_index(op.f('ix_email_logs_client_id'), 'email_logs', ['client_id'])
    op.create_index(op.f('ix_email_logs_status'), 'email_logs', ['status'])
    op.create_index(op.f('ix_email_logs_created_at'), 'email_logs', ['created_at'])
    op.create_index(op.f('ix_email_logs_sendgrid_message_id'), 'email_logs', ['sendgrid_message_id'])
...
def downgrade() -> None:
    ...
    op.drop_index(op.f('ix_clients_stage'), table_name='clients')
