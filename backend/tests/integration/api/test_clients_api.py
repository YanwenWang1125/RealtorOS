...
class TestCreateClient:
    ...
    @pytest.mark.asyncio
    async def test_create_client_success(self, async_client: AsyncClient):
    ...
    @pytest.mark.asyncio
    async def test_create_client_with_notes(self, async_client: AsyncClient):
    ...
    @pytest.mark.asyncio
    async def test_create_client_with_custom_fields(self, async_client: AsyncClient):
    ...
    @pytest.mark.asyncio
    async def test_create_client_missing_required_fields(self, async_client: AsyncClient):
    ...
    @pytest.mark.asyncio
    async def test_create_client_invalid_email(self, async_client: AsyncClient):
    ...
    @pytest.mark.asyncio
    async def test_create_client_invalid_stage(self, async_client: AsyncClient):
    ...
    @pytest.mark.asyncio
    async def test_create_client_invalid_property_type(self, async_client: AsyncClient):
    ...
    @pytest.mark.asyncio
    async def test_create_client_all_stages(self, async_client: AsyncClient):
...
class TestListClients:
    ...
    @pytest.mark.asyncio
    async def test_list_clients_empty(self, async_client: AsyncClient):
    ...
    @pytest.mark.asyncio
    async def test_list_clients_basic(self, async_client: AsyncClient):
        ...
        for i in range(5):
            ...
            await async_client.post("/api/clients/", json=client_data)
    ...
    @pytest.mark.asyncio
    async def test_list_clients_pagination(self, async_client: AsyncClient):
        ...
        # Test first page
        response1 = await async_client.get("/api/clients/?page=1&limit=5")
        assert response1.status_code == 200
        data1 = response1.json()
        assert len(data1) == 5
        
        # Test second page
        response2 = await async_client.get("/api/clients/?page=2&limit=5")
    ...
    @pytest.mark.asyncio
    async def test_list_clients_filter_by_stage(self, async_client: AsyncClient):
        ...
        response = await async_client.get("/api/clients/?stage=lead")
        assert response.status_code == 200
        data = response.json()
        assert len(data) >= 3
        ...
        response = await async_client.get("/api/clients/?stage=negotiating")
        assert response.status_code == 200
        data = response.json()
        assert len(data) >= 2
    ...
    @pytest.mark.asyncio
    async def test_list_clients_pagination_defaults(self, async_client: AsyncClient):
    ...
    @pytest.mark.asyncio
    async def test_list_clients_invalid_page(self, async_client: AsyncClient):
        """Test pagination with invalid page number."""
        response = await async_client.get("/api/clients/?page=0")
        assert response.status_code == 422  # Validation error for ge=1

    @pytest.mark.asyncio
    async def test_list_clients_invalid_limit(self, async_client: AsyncClient):
        """Test pagination with invalid limit value."""
        response = await async_client.get("/api/clients/?limit=0")
        assert response.status_code == 422  # Validation error for ge=1
        
        response = await async_client.get("/api/clients/?limit=101")
...
class TestGetClient:
    ...
    @pytest.mark.asyncio
    async def test_get_client_success(self, async_client: AsyncClient):
        ...
        # Get the client
        response = await async_client.get(f"/api/clients/{client_id}")
    ...
    @pytest.mark.asyncio
    async def test_get_client_not_found(self, async_client: AsyncClient):
        """Test getting a non-existent client returns 404."""
        response = await async_client.get("/api/clients/99999")
    ...
    @pytest.mark.asyncio
    async def test_get_client_invalid_id(self, async_client: AsyncClient):
        """Test getting a client with invalid ID format."""
        response = await async_client.get("/api/clients/not-a-number")
...
class TestUpdateClient:
    ...
    @pytest.mark.asyncio
    async def test_update_client_partial(self, async_client: AsyncClient):
        ...
        response = await async_client.patch(f"/api/clients/{client_id}", json=update_data)
    ...
    @pytest.mark.asyncio
    async def test_update_client_stage(self, async_client: AsyncClient):
    ...
    @pytest.mark.asyncio
    async def test_update_client_multiple_fields(self, async_client: AsyncClient):
    ...
    @pytest.mark.asyncio
    async def test_update_client_custom_fields(self, async_client: AsyncClient):
    ...
    @pytest.mark.asyncio
    async def test_update_client_not_found(self, async_client: AsyncClient):
        """Test updating a non-existent client returns 404."""
        update_data = {"name": "Won't Work"}
        response = await async_client.patch("/api/clients/99999", json=update_data)
    ...
    @pytest.mark.asyncio
    async def test_update_client_invalid_stage(self, async_client: AsyncClient):
...
class TestDeleteClient:
    ...
    @pytest.mark.asyncio
    async def test_delete_client_success(self, async_client: AsyncClient, db_session):
        ...
        # Delete the client
        response = await async_client.delete(f"/api/clients/{client_id}")
        ...
        list_response = await async_client.get("/api/clients/")
    ...
    @pytest.mark.asyncio
    async def test_delete_client_not_found(self, async_client: AsyncClient):
        """Test deleting a non-existent client returns 404."""
        response = await async_client.delete("/api/clients/99999")
    ...
    @pytest.mark.asyncio
    async def test_delete_client_then_get_returns_404(self, async_client: AsyncClient):
        ...
        # Delete the client
        await async_client.delete(f"/api/clients/{client_id}")
...
class TestGetClientTasks:
    ...
    @pytest.mark.asyncio
    async def test_get_client_tasks_empty(self, async_client: AsyncClient):
        ...
        # Get tasks
        response = await async_client.get(f"/api/clients/{client_id}/tasks")
    ...
    @pytest.mark.asyncio
    async def test_get_client_tasks_with_tasks(self, async_client: AsyncClient, db_session):
    ...
    @pytest.mark.asyncio
    async def test_get_client_tasks_not_found(self, async_client: AsyncClient):
        """Test getting tasks for non-existent client."""
        response = await async_client.get("/api/clients/99999/tasks")
...
class TestClientAPIIntegration:
    ...
    @pytest.mark.asyncio
    async def test_client_full_lifecycle(self, async_client: AsyncClient):
        ...
        # Read
        get_response = await async_client.get(f"/api/clients/{client_id}")
        assert get_response.status_code == 200
        assert get_response.json()["stage"] == "lead"
        
        # Update - progress through stages
        update_response1 = await async_client.patch(
        ...
        update_response2 = await async_client.patch(
            f"/api/clients/{client_id}",
            json={"stage": "closed"}
        )
        ...
        # Delete
        delete_response = await async_client.delete(f"/api/clients/{client_id}")
    ...
    @pytest.mark.asyncio
    async def test_list_clients_excludes_deleted(self, async_client: AsyncClient):
        ...
        # Delete some clients
        await async_client.delete(f"/api/clients/{client_ids[1]}")
        await async_client.delete(f"/api/clients/{client_ids[3]}")
